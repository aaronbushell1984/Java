...
public class ArrayListDemo {
	...
	public static void main(String[] args) {
		...
		// Collections object methods are used with array lists
		...
		// contain method and assigning boolean
		boolean isBookPresent = myBooks.contains(mySecondBook);
		System.out.println("is Book 2 here? " + isBookPresent);
		
		// remove method on custom class/object
		myBooks.remove(myFirstBook);
